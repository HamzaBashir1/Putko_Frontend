...
const FeatureCard = () => {
  return (
    <div className='flex flex-col border rounded-lg overflow-hidden w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg bg-white'>
      <div className='relative w-full h-56 sm:h-64'>
        {/* Premium Label */}
        <div className='absolute top-2 left-2 text-white text-xs sm:text-sm font-bold rounded-full px-2 py-1'>
          Premium
        </div>
        ...
        <div className='absolute top-2 left-2 text-[#FEF2F2] text-xs sm:text-sm rounded-full px-2 py-1 bg-[#4FBE9F] '>
          Premium
        </div>
      </div>
